...
// The AWS vendor autoload lives in the main application's third_party/vendor.
// From api/application/ we navigate up two levels to reach the main application.
