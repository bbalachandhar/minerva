                                     ...
                                     <table class="table mb0 paytable">
                                        ...
                                        <input type="hidden" name="key" value="<?php echo $mkey ?>" />
                                          ...
                                          <input name="curl" value="<?php echo $cancel ?>" type="hidden" />
                                           ...
                                           <?php if($session_data['gateway_processing_charge']>0){ ?>
                                                       <tr class="border_bottom">
                                            <td>
                                                <table class="table mb0 paytable"><tr><td><span class="text text-right"><?php echo ('Processing Fees'); ?>:</span></td>
                                          <td class="text-right"><?php echo amountFormat((float) $session_data['gateway_processing_charge'], 2, '.', ''); ?></td></tr></table></td>
                                        </tr>
                                    <?php } ?>
                                           <tr class="paybtngray">
                                            <td><button type="submit" name="search" value="" class="btn btn-info buttondarkgray">Pay With PayU <span class="bolds"><?php
                                                
                                                if(!empty($session_data['total_amount'])){ echo amountFormat($session_data['total_amount']+$session_data['gateway_processing_charge']);}else{echo '0.00';} ?></span></button></td>
                                        </tr>              
                                      </table>
