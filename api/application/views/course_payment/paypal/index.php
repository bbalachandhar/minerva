                            ...
                            <div class="paybody">
                                <form class="paddtlrb" action="<?php echo site_url('course_payment/paypal/pay') ?>" method="POST" id="paypalForm">
                                    ...
                                    <table class="table mb0 paytable">
                                          ...
                                          <td class="text-right"><?php echo amountFormat((float) $session_params['gateway_processing_charge'], 2, '.', ''); ?></td></tr></table></td>
                                        </tr>
                                    <?php } ?>
                                                <tr class="paybtngray">
                                                  <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray">Pay With Paypal <span class="bolds"><?php
                                                     
                                                      if(!empty($session_params['total_amount'])){ echo amountFormat($session_params['total_amount']+$session_params['gateway_processing_charge']);}else{echo '0.00';} ?></span></button></td>
                                              </tr>   
                                            </table>
