...
<html lang="en">
    <head>
        ...
        <title>Toyyibpay Pay Custom Integration</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url();?>/backend/images/toyyibpay.png" style="margin-bottom: 10px;"><br />Toyyibpay Payment Gateway</h3>
                            <div class="paybody">
                                ...
                                <form action="<?php echo base_url(); ?>gateway/toyyibpay/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            <td bgcolor="#fff">  </td>
                                            <td bgcolor="#fff" class="text-right"> <button type="submit" name="search" value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Toyyibpay'); ?></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>    
