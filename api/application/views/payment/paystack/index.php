        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url();?>/backend/images/paystack.png" style="height: 40px; margin-bottom: 10px;"><br />Paystack Payment Gateway</h3>
                            <div class="paybody">
                                                ...
                                                <table class="table2" width="100%">
                                                    ...
                                                    <tr class="bordertoplightgray">
													 ...
													 <tr class="border_bottom">
														<td>
															<span class="text-text-success"><?php echo ('Discount'); ?></span>
														</td>
														<td class="text-right"><?php echo amountFormat((float) $params['applied_fee_discount'], 2, '.', ''); ?></td>
													</tr>
