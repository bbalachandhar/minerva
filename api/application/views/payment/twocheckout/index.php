...
<html lang="en">
    <head>
        ...
        <title>Twocheckout Pay Custom Integration</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url();?>/backend/images/twocheckout.png" style="margin-bottom: 10px;"><br />Twocheckout Payment Gateway</h3>
                            <div class="paybody">
                                ...
                                <form action="<?php echo base_url(); ?>gateway/twocheckout/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="phone" required value="<?php echo set_value('phone', isset($params['guardian_phone']) ? $params['guardian_phone'] : ''); ?>" /></td>
                                        </tr>

                                        <tr class="bordertoplightgray">
                                            <td bgcolor="#fff"><?php echo ('Email'); ?>:</td>
                                            <td bgcolor="#fff" class="text-right"> <input type="email" class="form-control" name="email" required value="<?php echo set_value('email', isset($student_data->guardian_email) ? $student_data->guardian_email : ''); ?>" ></td>
                                        </tr>
                                        
                                        <tr><td colspan="2"><hr /></td></tr>
                                        <tr class="bordertoplightgray">
                                            <td bgcolor="#fff">  </td>
                                            <td bgcolor="#fff" class="text-right"> <button type="submit" name="search" value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Twocheckout'); ?></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>    
