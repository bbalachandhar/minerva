        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url();?>/backend/images/walkingm.png" style="margin-bottom: 10px;"><br />Walkingm Payment Gateway</h3>
                            <div class="paybody">
                                ...
                                <div class="">
                                    <div class="paymentbg">
                                        ...
                                        <div class="padd2 paddtzero">
                                            <form action="<?php echo base_url(); ?>gateway/walkingm/pay" method="post">
                                                <table class="table2" width="100%">
                                                    ...
                                                    <tr class="bordertoplightgray">
                                                        ...
                                                        <td bgcolor="#fff" class="text-right"> <?php echo amountFormat($params['applied_fee_discount']); ?></td>
                                                    </tr>
                                                    ...
                                                    <tr class="bordertoplightgray">
                                                        ...
                                                        <td bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email'); ?>" /></td>
                                                    </tr>
                                                    <tr class="bordertoplightgray">
                                                        <td bgcolor="#fff"><?php echo ('Walkingm Password'); ?>:</td>
                                                        <td bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="password" value="<?php echo set_value('password'); ?>"></td>
                                                    </tr>
                                                    <tr><td colspan="2"><hr /></td></tr>
                                                    <tr class="bordertoplightgray">
                                                        <td bgcolor="#fff">  </td>
                                                        <td bgcolor="#fff" class="text-right"> <button type="submit"  name="search" value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Walkingm'); ?></button>  </td>
                                                    </tr>
                                                </table>
