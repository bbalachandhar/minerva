                                ...
                                <form action="<?php echo base_url(); ?>gateway/walkingm/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td bgcolor="#fff" class="text-right"> <input type="email" class="form-control" name="email" required value="<?php echo set_value('email'); ?>" /></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td bgcolor="#fff"><?php echo ('Walkingm Password'); ?>:</td>
                                            <td bgcolor="#fff" class="text-right"> <input type="password" class="form-control" name="password" required value="<?php echo set_value('password'); ?>"></td>
                                        </tr>
