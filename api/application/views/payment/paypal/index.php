                            ...
                            <div class="paybody">
                                <form class="paddtlrb" action="<?php echo site_url('gateway/paypal/pay') ?>" method="POST" id="paypalForm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><div class="form-control"><?php echo amountFormat((float) $session_params['applied_fee_discount'], 2, '.', ''); ?></div></div>
                                    </div><!--./form-group-->	
                                    ...
                                    <?php }?>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><div class="form-control"><?php echo amountFormat($session_params['payment_detail']->fine_amount+$session_params['total']-$session_params['applied_fee_discount']+$session_params['gateway_processing_charge']); ?></div></div>
                                    </div><!--./form-group-->
