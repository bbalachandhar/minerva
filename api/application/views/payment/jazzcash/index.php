        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url();?>/backend/images/jazzcash.jpg" style="margin-bottom: 10px;"><br />JazzCash Payment Gateway</h3>
                            <div class="paybody">
                                <?php if ($this->session->flashdata('msg')) { ?>
                                    <center><div class="alert alert-danger"><?php echo $this->session->flashdata('msg') ?></div></center>
                                <?php } ?>
                                ...
                                <form action="<?php echo base_url(); ?>gateway/Jazzcash/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td bgcolor="#fff" class="text-right"><?php echo isset($params['guardian_phone']) ? $params['guardian_phone'] : ''; ?></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td bgcolor="#fff"><?php echo ('Email'); ?>:</td>
                                            <td bgcolor="#fff" class="text-right"> <?php echo isset($student_data->guardian_email) ? $student_data->guardian_email : ''; ?></td>
                                        </tr>
