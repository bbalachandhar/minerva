        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="paybody">
                                ...
                                <form action="<?php echo $action; ?>" method="post" name="payuForm" id="payuForm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><input class="form-control" name="amount" value="<?php echo $session_params['gateway_processing_charge']; ?>" readonly="readonly"/></div>
                                    </div><!--./form-group-->
                                <?php } ?>
                                <?php
                                    foreach ($params['student_fees_master_array'] as $fees_key => $fees_value) {
                                        ...
                                        <tr class="border_bottom">
                                            ...
                                            <td class="text-right"><?php echo $fees_value['fine_balance']; ?></td>
                                        </tr>
                                          <div class="form-group row">
                                        <label class="col-sm-4"><span class="title"><?php if ($fees_value['is_system']) {
                ...
                echo $fees_value['fee_type_code'];
                                        ...
                                        <div class="col-sm-8"><input name="firstname" class="form-control" id="firstname" value="<?php echo $fees_value['amount_balance'];  ?>" readonly="readonly" /></div>
                                    </div><!--./form-group-->
                                        <?php
                                    }
                                    ?>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><input class="form-control" name="amount" value="<?php echo set_value('amount', (+$session_params['total']- $session_params['applied_fee_discount']+$session_params['gateway_processing_charge'])) ?>" readonly="readonly"/></div>
                                    </div><!--./form-group-->
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><input name="email" class="form-control" id="email" value="<?php echo set_value('email', '') ?>" /></div>
                                    </div><!--./form-group-->
