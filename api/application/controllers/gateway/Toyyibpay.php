        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->session->has_userdata('params')) {
             ...
             $payment_data = array(
                ...
                'billPriceSetting'=>1,
                'billPayorInfo'=>1,
                'billAmount'=>convertBaseAmountCurrencyFormat($session_params['payment_detail']->fine_amount+$session_params['total'] - $session_params['applied_fee_discount']+ $session_params['gateway_processing_charge']),
