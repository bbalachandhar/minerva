...
class Mollie extends Admin_Controller {
    ...
    public function pay() {
        ...
        $data['student_data'] = $this->student_model->get($data['params']['student_id']);
            ...
            $amount =convertBaseAmountCurrencyFormat($data['session_params']['payment_detail']->fine_amount+$data['session_params']['total']- $data['session_params']['applied_fee_discount']+$data['session_params']['gateway_processing_charge']);
