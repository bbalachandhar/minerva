...
class Paystack extends Admin_Controller {
    ...
    public function paystack_pay() {
        ...
        $total=number_format((float)(convertBaseAmountCurrencyFormat($params['payment_detail']->fine_amount+$params['total'] - $params['applied_fee_discount']+ $params['gateway_processing_charge'] )), 2, '.', '');
