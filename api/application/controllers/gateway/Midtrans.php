...
class Midtrans extends Admin_Controller {
    ...
    public function index() {
        ...
        $transaction = array(
            ...
            'order_id' => time(),
            'gross_amount' => round(number_format((float)(convertBaseAmountCurrencyFormat($data['params']['payment_detail']->fine_amount+$data['params']['total']- $data['params']['applied_fee_discount']+$data['params']['gateway_processing_charge'])), 2, '.', '')), // no decimal allowed
            ),
        );
