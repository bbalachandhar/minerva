...
class Gateway_ins_model extends CI_Model
{
    ...
    public function get_api_session($id){
          return $this->db->select('*')->from('api_session')->where(array('api_session.id' => $id))->get()->row_array();
    }
...
$this->db->where('id', $id);
    ...
    public function add_api_session($params)
    {
