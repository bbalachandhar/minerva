...
class Setting_model extends CI_Model
{
    ...
    public function get($id = null)
    {
        $this->db->select('sch_settings.id,sch_settings.lang_id,sch_settings.class_teacher,sch_settings.is_rtl,sch_settings.cron_secret_key, sch_settings.timezone,sch_settings.attendence_type,sch_settings.superadmin_restriction,
          sch_settings.name,sch_settings.email,sch_settings.phone,languages.language,languages.short_code,          sch_settings.address,sch_settings.dise_code,sch_settings.date_format,sch_settings.currency,sch_settings.currency_symbol,sch_settings.start_month,sch_settings.session_id,sch_settings.start_week,sch_settings.lastname,sch_settings.middlename,sch_settings.fee_due_days,sch_settings.image,sch_settings.theme,sessions.session,sch_settings.student_login,sch_settings.parent_login,currencies.symbol as currency_symbol,currencies.base_price,currencies.short_name,currencies.short_name as currency_short_name,sch_settings.saas_key,sch_settings.folder_path,'
        );
    ...
    {
        $this->db->select('sch_settings.student_timeline,sch_settings.id,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.timezone,
          sch_settings.name,sch_settings.email,sch_settings.phone,languages.language,sch_settings.attendence_type,          sch_settings.address,sch_settings.dise_code,sch_settings.date_format,sch_settings.currency,sch_settings.currency_symbol,sch_settings.start_month,sch_settings.session_id,sch_settings.image,sch_settings.theme,sessions.session,student_profile_edit,sch_settings.staff_profile_edit,sch_settings.is_student_feature_lock,sch_settings.lock_grace_period,sch_settings.fees_discount'
        );
        $this->db->from('sch_settings');
        $this->db->join('sessions', 'sessions.id = sch_settings.session_id');
        $this->db->join('languages', 'languages.id = sch_settings.lang_id');
