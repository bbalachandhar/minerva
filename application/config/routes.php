...
$route['admin/timetable/grid']         = 'admin/timetable/grid';
$route['admin/timetable/savecell']     = 'admin/timetable/savecell';
$route['admin/timetable/deletecell']   = 'admin/timetable/deletecell';
...
$route['public_admission/applicant_logout'] = 'public_admission/applicant_logout';
$route['public_admission/payment_history'] = 'public_admission/payment_history';
