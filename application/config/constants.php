...
defined('DEBUG_SYSTEM_UPDATE') OR define('DEBUG_SYSTEM_UPDATE', '');

defined('DEBUG_SYSTEM_CHECK_UPDATE') OR define('DEBUG_SYSTEM_CHECK_UPDATE', '');
...
defined('DEBUG_SYSTEM_APP') OR define('DEBUG_SYSTEM_APP', '');

defined('DEBUG_SYSTEM_APP_REG') OR define('DEBUG_SYSTEM_APP_REG', '');
...
defined('DEBUG_SYSTEM_MBANCH') OR define('DEBUG_SYSTEM_MBANCH', '');

defined('DEBUG_SYSTEM_ADD_CK') OR define('DEBUG_SYSTEM_ADD_CK', '');
