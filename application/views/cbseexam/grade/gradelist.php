                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg">
                            ...
                            <?php } ?>
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('exam_grade_list'); ?>">
                                <thead>
                                    <tr>
...
<tr>
   ...
   <td class="v-align-top"><?php echo $datavalue['maximum_percentage'];?></td>
   <td class="v-align-top"><?php echo $datavalue['minimum_percentage'];?></td>
   <td class="v-align-top"><?php echo $datavalue['description'];?></td>
  </tr>
                                                    <?php 
                                                    }
                                                     ?>
                                        ...
                                        <td class="white-space-nowrap v-align-top"> 
                                        
                                            <?php if ($this->rbac->hasPrivilege('cbse_exam_grade', 'can_edit')) { ?>
                                            <span data-toggle="tooltip" >
                                            <button type="button" data-record_id="<?php echo $value['id']; ?>" class="btn btn-primary btn-xs" data-action="update" data-originaltitle="<?php echo $this->lang->line('edit_grade'); ?>" data-toggle="modal" data-target="#myModal" data-original-title="<?php echo $this->lang->line('edit_grade'); ?>" title="<?php echo $this->lang->line('edit_grade'); ?>" autocomplete="off"><i class="fa fa-pencil"></i></button></span> 
                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam_grade', 'can_delete')) { ?>                                            
                                            <a data-id="<?php echo $value['id'] ?>" class="btn btn-primary btn-xs deletegrade"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-remove"></i></a>
