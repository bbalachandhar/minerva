...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php
if ($this->rbac->hasPrivilege('cbse_exam_admit_card', 'can_add')) {
    ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('cbseexam/cbseadmitcard/edit/' . $admitcard->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8">
                            <div class="box-body">
    ...
    ?>
                                    ...
                                    <?php if(!empty($admitcard->left_logo)){
                                        ...
                                        <div class="left_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeleft_logo()"></i></a><?php echo $admitcard->left_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(!empty($admitcard->right_logo)){
                                        ...
                                        <div class="right_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeright_logo()"></i></a><?php echo $admitcard->right_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(!empty($admitcard->right_logo)){
                                        ...
                                        <div class="sign">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removesign()"></i></a><?php echo $admitcard->sign; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(!empty($admitcard->background_img)){
                                        ...
                                        <div class="background_image">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removebackground_image()"></i></a><?php echo $admitcard->background_img; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_father_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_mother_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_dob" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_admission_no" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_roll_no" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_address" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_gender" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_photo" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_class" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_section" class="label-info-success"></label>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('admit_card_list'); ?>">
                                <thead>
                                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if ($certificate->background_img != '' && !is_null($certificate->background_img)) {?>
                                                        <img src="<?php echo $this->media_storage->getImageURL('uploads/cbseexam/admit_card/'. $certificate->background_img); ?>" width="40">
                                                    <?php } else {?>
                                                ...
                                                <td class="mailbox-date text-right no-print white-space-nowrap">
                                                    <a data-toggle="tooltip" id="<?php echo $certificate->id ?>" class="btn btn-primary btn-xs view_data" title="<?php echo $this->lang->line('view'); ?>">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
													
                                                    <?php if ($this->rbac->hasPrivilege('design_admit_card', 'can_edit')) {   ?>
													
                                                        <a href="<?php echo site_url('cbseexam/cbseadmitcard/edit/' . $certificate->id); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
														
                                                    <?php }  if ($this->rbac->hasPrivilege('design_admit_card', 'can_delete')) { ?>
														
                                                        <a href="<?php echo base_url(); ?>cbseexam/cbseadmitcard/delete/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.view_data').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('cbseexam/cbseadmitcard/view') ?>",
                method: "post",
...
<script type="text/javascript">
    ...
    function save_active_status(value){
        $.ajax({
                url: "<?php echo base_url('cbseexam/cbseadmitcard/save_active_status') ?>",
                method: "post",
                data: {value: value},
                success: function (data) {
