...
if ($admitcard->background_img != "") {
            ?>
                <img src="<?php echo $this->media_storage->getImageURL('uploads/cbseexam/admit_card/' . $admitcard->background_img); ?>" class="tcmybg" width="100%" height="100%" />
                <?php
}
        ?>
...
if ($admitcard->left_logo != "") {
                ?>
                                            <img src="<?php echo  $this->media_storage->getImageURL('uploads/cbseexam/admit_card/' . $admitcard->left_logo); ?>" width="100" height="100">
                                            <?php
}
            ?>
                                    </td>
...
if ($admitcard->right_logo != "") {
                ?>
                                            <img src="<?php echo  $this->media_storage->getImageURL('uploads/cbseexam/admit_card/' . $admitcard->right_logo); ?>" width="100" height="100">
...
foreach ($exam_subjects as $subject_key => $subject_value) {
            ?>
                                <tr>
                                    <td valign="top" style="text-align: center;"><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($subject_value->date)) . " " . $subject_value->time_from; ?></td>
                                    <td style="text-align: center;text-transform: uppercase;"><?php echo $subject_value->code; ?></td>
                                    <td style="text-align: center;text-transform: uppercase;"><?php echo $subject_value->name; ?></td>
                                    <td style="text-align: center;text-transform: uppercase;"><?php echo $subject_value->type; ?></td>
                                </tr>
                                <?php
}
        ?>
                    ...
                    <tr>
                        <td align="right" valign="top">
                            <table cellpadding="0" cellspacing="0" width="100%" style="text-align: center;">
                                <tr>
                                    <td valign="top">
                                        <img src="<?php echo  $this->media_storage->getImageURL('uploads/cbseexam/admit_card/' . $admitcard->sign); ?>" width="100" height="38"  />
                                    </td>
                                </tr>
                            </table>
                        </td>
