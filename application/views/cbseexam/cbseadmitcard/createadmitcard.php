    ...
    ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('cbseexam/cbseadmitcard/index') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date text-right no-print white-space-nowrap">
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('cbse_exam_admit_card', 'can_edit')) {  ?>
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('cbse_exam_admit_card', 'can_delete')) {  ?>
