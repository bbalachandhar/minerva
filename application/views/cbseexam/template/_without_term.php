  ...
  ?>
        ...
        foreach ($value['exam'] as $examkey => $examvalue) { 
            ...
            <tr>
                ...
                <td >
                    <div class="d-flex justify-content-center">
                        <input type="radio" class="checkbox checkBoxExam" <?php if($examvalue['id']==$templatedata['subjectnoteexam_id']){ echo "checked";} ?> name="subject_note" value="<?php echo $examvalue['id'];?>"> 
                    </div>    
                </td>
            </tr>
            <?php
        ...
        foreach ($value['exam'] as $examkey => $examvalue) { 
            ...
            <tr>
                ...
                <td >
                    <div class="d-flex justify-content-center">
                        <input type="radio" class="checkbox checkBoxExam" <?php if($examvalue['id']==$templatedata['remarkexam_id']){ echo "checked";} ?> name="subject_note" value="<?php echo $examvalue['id'];?>"> 
                    </div>    
                </td>
            </tr>
            <?php
