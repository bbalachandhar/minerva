                                        ...
                                        <tr>
                                            ...
                                            <td>                                    
                                                ...
                                                if ($this->rbac->hasPrivilege('cbse_exam_template', 'can_edit')) { ?>
                                                    ...
                                                    <a onclick="edit('<?php echo $value['id']; ?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
...
<div id="myModal" class="modal fade " role="dialog">
    <div class="modal-dialog modal-full-width m-0 modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
					...
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-1 col-sm-3 col-xs-2">
                                <div class="material-switch switchcheck pt0">
                   ...
                   <div class="form-group">                 
					    <div class="row">
						    ...
						    <div class="col-md-1 col-sm-3 col-xs-2">
                                <div class="material-switch switchcheck pt0">
									...
									<label for="exam_session" class="label-info-success"></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 col-sm-3 col-xs-2">
                                <div class="material-switch switchcheck pt0">
                                    ...
                                    <label for="remark" class="label-info-success"></label>
                                </div>
                            </div>                         
                        </div> 
                    </div>   
                    <div class="form-group">                
                        <div class="row">
                            <div class="col-md-2 col-sm-9 col-xs-10">
                                <label><?php echo $this->lang->line('subject_note') ?></label>                                
                            </div>
                            <div class="col-md-1 col-sm-2 col-xs-2">
                                <div class="material-switch switchcheck pt0">
                                    <input id="subject_note" name="subject_note" type="checkbox" class="chk" value="1">
                                    <label for="subject_note" class="label-info-success"></label>
                                </div>
                            </div>                         
                        </div>                    
                    </div>
...
<div id="editModal" class="modal fade " role="dialog">
    <div class="modal-dialog modal-full-width m-0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
