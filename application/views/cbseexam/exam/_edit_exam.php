...
<div id="<?php echo $delete_string;?>">  
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
             <div class="form-group">
                <label class="radio-inline"><input type="radio"  <?php if($result['use_exam_roll_no']==1){ echo "checked='checked'";} ?> value="1" name="use_exam_roll_no" ><?php echo $this->lang->line('admit_card_roll_no') ?>  </label>
                <label class="radio-inline"><input <?php if($result['use_exam_roll_no']==0){ echo "checked='checked'";} ?> type="radio" value="0" name="use_exam_roll_no"><?php echo $this->lang->line('profile_roll_no') ?>  </label>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('select_template_to_mail') ?></label> 
                <select  id="template" name="template" class="form-control" ><small class="req"> *</small>
                        ...
                        <div class="form-group">
                            ...
                            <select autofocus="" id="cbse_category_id" name="cbse_category_id" class="form-control" >
                                    ...
                                    foreach ($cbse_category as $value) {
                                         $cbse_category_id = '';
                        if($result['cbse_category_id'] == $value->id){
                           $cbse_category_id = 'selected';
                        }
                                        ?>
                                        <option <?php
                                       
                                        ?> value="<?php echo $value->id ?>"  <?php echo $cbse_category_id; ?>><?php echo $value->name; ?></option>
                                            <?php
                                        }
                                        ?>
                            </select>
