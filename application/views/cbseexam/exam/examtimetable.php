                ...
                <div class="box box-primary">
                    ...
                    $i=0;
                                if (!empty($exams)) {
                                    ...
                                    <a class="btn btn-primary btn-xs pull-right mt8 mr-1" id="print" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('print'); ?>" onclick="printDiv('print_<?php echo $i;?>')"><i class="fa fa-print"></i></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($exam_value->time_table as $time_table_key => $time_table_value) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <?php 
                                                            $time_table_subject_code = ($time_table_value->subject_code != "") ? " (" . $time_table_value->subject_code . ")" : "";
                                                            
                                                            echo $time_table_value->subject_name . $time_table_subject_code ?>
                                                            </td>
