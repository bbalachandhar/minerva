...
$sub_code = ($exam_subject_value['subject_code'] != "") ? " (" . $exam_subject_value['subject_code'] . ")" : "";

echo $exam_subject_value['subject_name']. $sub_code; ?>
</td>
                ...
                <td class="col-sm-1 text-right">                                             
                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#subjectModal" data-subject_name="<?php echo $exam_subject_value['subject_name']; ?>" data-exam_id="<?php echo $examDetail['id']; ?>" data-subject_id="<?php echo $exam_subject_value['subject_id']; ?>" data-timetable_id="<?php echo $exam_subject_value['id']; ?>" ><i class="fa fa-newspaper-o"  aria-hidden="true"></i></button>
                </td>
            </tr>
    <?php
            }
