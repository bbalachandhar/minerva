  ...
  <?php  
           ...
           ?>
            ...
            <a href="<?php echo base_url(); ?>student/view/<?php echo $student_value->id; ?>"><?php echo $this->customlib->getFullName($student_value->firstname,$student_value->middlename,$student_value->lastname,$sch_setting->middlename,$sch_setting->lastname); ?>
                        ...
                        <button  type="button" class="btn btn-primary btn-xs download_pdf" data-action="download" data-toggle="tooltip"  data-original-title="<?php echo $this->lang->line('download'); ?>"  data-template_id=" <?php echo set_value('template');?>" data-student_session_id="<?php echo $student_value->student_session_id; ?>"  data-admission_no="<?php echo $student_value->admission_no;?>" data-student_name="<?php echo $student_value->firstname; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" ><i class="fa fa-download"></i></button>

                       <button  type="button" data-original-title="<?php echo $this->lang->line('email'); ?>"   class="btn btn-primary btn-xs email_pdf" data-action="email" data-template_id=" <?php echo set_value('template');?>" id="load1" data-toggle="tooltip"  data-original-title="<?php echo $this->lang->line('sent_to_email'); ?>" data-student_session_id="<?php echo $student_value->student_session_id; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" ><i class="fa fa-envelope"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $count++;
