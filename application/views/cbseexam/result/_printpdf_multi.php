...
$rank_overall_term_student_name_keys = array_column($student_allover_term_rank, 'firstname');
array_multisort($rank_overall_term_percentage_keys, SORT_DESC, $rank_overall_term_student_name_keys, SORT_ASC, $student_allover_term_rank);
    ...
    <div style="width: 100%; margin: 0 auto;">
      ...
      ?>
              ...
              <thead>
                <tr>
                  ...
                  foreach ($exam_term_exam_assessment as $assess_key => $assess_value) {
                    ...
                    $terms_weight_array[] = $assess_value['cbse_term_name'] . " (" . $assess_value['cbse_term_weight'] . ")";
                  ?>

                  <!-- template data hide show condition -->
                    <td valign="middle" class="text-center" colspan="<?php echo $term_colspan + 2 ; ?>"><?php 
                    
                    $cbse_term_code = ($assess_value['cbse_term_code'] != "") ? " (" . $assess_value['cbse_term_code'] . ")" : "";
                    
                    echo $assess_value['cbse_term_name'] . $cbse_term_code; ?>
                  ...
                  ?>
                    <?php if ($template['is_subject_note'] == 1) { $colspan=1; }else{  $colspan=0;  } ?>

                  <td valign="middle" class="text-center" colspan="<?php echo $colspan + 3 ; ?>">
                    <?php
                    //term merge array              
                ...
                <tr>
                  ...
                  foreach ($exam_term_exam_assessment as $assess_key => $assess_value) {
                    ...
                    foreach ($assess_value['exams'] as $exam_key => $exam_value) {
                      $total_total_working_day += ($exam_value['total_working_days']);

                      if (array_key_exists($assess_value['cbse_term_id'], $student_value['terms'])) {
                  ...
                  ?>
                    ...
                    ?>
                    <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('total'); ?></td>
                    <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('grade'); ?></td>
                  <?php } ?>
                  <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('grand_total'); ?> <br /> <?php echo $this->lang->line('out_of'); ?> (100)</td>
                  <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('grade'); ?></td>
                  <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('rank'); ?></td>
                  <?php if ($template['is_subject_note'] == 1) {?>
                  <td rowspan="2" valign="middle" class="text-center"><?php echo $this->lang->line('note'); ?></td>
                  <?php } ?>
                </tr>
                <tr>
                  <?php
                  ...
                  ?> 
                        <td valign="top" class="text-center"><?php
                          $exam_assement_code = ($exam_assement_value['code'] != "") ? " (" . $exam_assement_value['code'] . ")" : "";
                          echo $exam_assement_value['name'] . $exam_assement_code;
                          echo "<br/>";
                ...
                ?>
                  <tr>
                    ...
                    <td valign="top"><?php echo $subject_array_value; ?>
                    ...
                    ?>
                      ...
                      ?>
                      <td valign="top" class="text-center"><?php echo amountFormat($subject_total); ?></td>
                      <td valign="top" class="text-center">
                        ...
                        echo getGrade($exam_grades, $subject_percentage);
                    ...
                    ?>
                    <td valign="top" class="text-center"><?php echo amountFormat($subject_total_term_percentage); ?></td>
                    <td valign="top" class="text-center"><?php echo getGrade($exam_grades, $subject_total_term_percentage); ?></td>
                    <td valign="top" class="text-center"><?php echo searchSubjectRank($student_value['subject_rank'], $subject_array_key); ?></td>
                    <?php if ($template['is_subject_note'] == 1) {?>
                    <td valign="top" class="text-center"><?php
                    echo $this->customlib->get_subject_remark($subjectnoteexam_id,$student_value['student_session_id'],$subject_array_key);
                    ?></td>
                    <?php } ?>
                ...
                ?>
                  ...
                  <td valign="top" <?php echo ($td == 2) ? "align='right'" : "align='left'" ?>>
                    <table cellpadding="0" cellspacing="0" width="100%" class="denifittable-small">
                      <tr>
                        <td valign="top" colspan="<?php echo count($obs_value['cbse_terms']) + 1; ?>"><?php echo $obs_value['cbse_observation_name']; ?></td>
                      </tr>
                      <tr>
                      ...
                      ?>
                        <tr>
                          <td><?php echo $cbse_obs_parma_value->name; ?></td>
        ...
        <tr>
          ...
          <td valign="top" class="text-left" colspan="<?php echo $total_colspans; ?>">
