            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="denifittable">
              <thead>
                <tr>
                  ...
                  ?>
                   <?php if ($template['is_subject_note']) { $colspan=1; }else{ $colspan=0 ;} ?>

                    <td valign="middle" class="text-center" colspan="<?php echo $term_colspan + $colspan + 3; ?>"><?php 
                ...
                <tr>
                  ...
                  ?>
                    ...
                    <td colspan="<?php echo $colspan+3;?>" valign="middle" class="text-center">
                      <?php
                      //term merge array              
                ...
                <tr>
                  ...
                  <?php if ($template['is_subject_note']) { ?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="denifittable">
              <tbody>
                <tr>
                  ...
                  $overall_percentage = getPercent((count($subject_array) * 100), $grand_total_term_percentage);
                  ?>
                  <td class="border-t-0"><?php echo $this->lang->line('overall_marks'); ?> : <?php echo two_digit_float($grand_total_term_percentage, 2) . "/" . count($subject_array) * 100; ?></td>
                  <td class="border-t-0"><?php echo $this->lang->line('percentage'); ?> : <?php echo two_digit_float($overall_percentage, 2); ?></td>
                  <td class="border-t-0"><?php echo $this->lang->line('grade'); ?> : <?php echo getGrade($exam_grades, $overall_percentage); ?></td>
