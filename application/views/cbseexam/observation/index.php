                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">                    
                            <?php if ($this->rbac->hasPrivilege('cbse_exam_observation', 'can_add')) { ?> 
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-record_id="0" data-original-title="<?php echo $this->lang->line('add_observation')?>"  data-action="add" data-toggle="modal"  data-placement="bottom" data-target="#myModal" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add')?></button> 
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg">
                            ...
                            <?php } ?>
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('observation_list'); ?>">
                                <thead>
                                    <tr>
                                   ...
                                   foreach ($result as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="white-space-nowrap">                                        
                                            ...
                                            <button type="button" data-record_id="<?php echo $value['id']; ?>" class="btn btn-primary btn-xs" data-action="update" data-toggle="modal" data-target="#myModal" data-original-title="<?php echo $this->lang->line('edit_observation')?>" title="<?php echo $this->lang->line('edit_observation')?>" autocomplete="off"><i class="fa fa-pencil"></i></button>  
                                            
                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam_observation', 'can_delete')) { ?>
                                            
                                            <a href="<?php echo site_url('cbseexam/observation/delete/'.$value['id']); ?>" data-id="<?php echo $value['id'] ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_want_to_delete'); ?>');" class="btn btn-primary btn-xs deleteobservation"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-remove"></i></a>
