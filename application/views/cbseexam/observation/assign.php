            ...
            <div class="col-md-12">             
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools box-tools-md">
						
                            <?php if ($this->rbac->hasPrivilege('cbse_exam_assign_observation', 'can_add') && $this->rbac->hasPrivilege('cbse_exam_assign_observation', 'can_view')) { ?>
                            <button type="button" class="btn btn-sm btn-primary mb5"  data-record_id="0" data-original-title="<?php echo $this->lang->line('add_observation_term')?>"  data-action="add" data-placement="bottom" data-toggle="modal" data-target="#myModal" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add')?></button>
                            <?php } ?>					
							 
                            <?php if ($this->rbac->hasPrivilege('cbse_exam_observation_parameter', 'can_view')) { ?>
                            <a type="button" class="btn btn-sm btn-primary mb5" href="<?php echo site_url('cbseexam/observationparameter') ?>"  data-originaltitle="<?php echo $this->lang->line('observation_parameter')?>" ><?php echo $this->lang->line('observation_parameter')?></a> 
                            <?php } ?> 

							<?php if ($this->rbac->hasPrivilege('cbse_exam_observation', 'can_view')) { ?>
                            <a type="button" class="btn btn-sm btn-primary mb5" href="<?php echo site_url('cbseexam/observation/index') ?>"  data-originaltitle="<?php echo $this->lang->line('observation')?>" ><?php echo $this->lang->line('observation')?></a> 
                            <?php } ?>		
