...
.crud-header h2 .header-icon {
    width: 40px; height: 40px; border-radius: 10px;
    background: linear-gradient(135deg, #5b73e8, #7c5ce7);
    display: flex; align-items: center; justify-content: center;
    color: #fff; font-size: 18px;
}
.crud-header .badge-count {
    background: #e8ebf7; color: #5b73e8; padding: 4px 14px;
    border-radius: 20px; font-size: 13px; font-weight: 600; margin-left: 8px;
}
.btn-add-new {
    background: linear-gradient(135deg, #5b73e8, #7c5ce7); color: #fff;
...
.crud-table thead th {
    ...
    letter-spacing: .5px; color: #8492a6; border-bottom: 2px solid #eef0f3;
}
...
.crud-table .item-id {
    display: inline-block; background: #f0f2ff; color: #5b73e8;
...
.crud-modal-body label {
    font-weight: 600; font-size: 13px; color: #495057; margin-bottom: 6px; display: block;
}
.crud-modal-body label .req { color: #e74c3c; }
.crud-input {
    width: 100%; background: #f8f9fa; border: 1px solid #dee2e6;
    border-radius: 8px; padding: 10px 14px; font-size: 14px; color: #333;
        ...
        <div class="crud-page">
            ...
            <div class="crud-header">
                ...
                <button class="btn-add-new" onclick="openModal()">
                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('create_category'); ?>
                </button>
                <?php endif; ?>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <a href="<?php echo base_url(); ?>category/edit/<?php echo $category['id']; ?>" class="btn-action btn-action-edit" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <?php endif; ?>
                                <?php if ($this->rbac->hasPrivilege('student_categories', 'can_delete')): ?>
                                <a href="<?php echo base_url(); ?>category/delete/<?php echo $category['id']; ?>" class="btn-action btn-action-delete" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>');">
...
<div class="crud-modal-overlay" id="crudModal">
    <div class="crud-modal">
        <div class="crud-modal-header">
            <h3><i class="fa fa-plus-circle" style="color:#5b73e8;margin-right:6px;"></i> <?php echo $this->lang->line('create_category'); ?></h3>
        ...
        <form action="<?php echo site_url('category/create'); ?>" method="post">
            ...
            <div class="crud-modal-body">
                ...
                <input type="text" name="category" class="crud-input" placeholder="<?php echo $this->lang->line('category'); ?>" value="<?php echo set_value('category'); ?>" autofocus>
...
<?php if (form_error('category')): ?>openModal();<?php endif; ?>
</script>
