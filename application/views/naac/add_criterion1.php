...
<?php echo form_open('naac/add_criterion1'); ?>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="learning_outcomes" name="learning_outcomes"><?php echo set_value('learning_outcomes'); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="stakeholder_feedback_mechanism" name="stakeholder_feedback_mechanism"><?php echo set_value('stakeholder_feedback_mechanism'); ?></textarea>
    </div>

    <div class="form-group">
        <label for="document_link">Document Link</label>
        <input type="url" class="form-control" id="document_link" name="document_link" value="<?php echo set_value('document_link'); ?>">
    </div>
