        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="<?php echo site_url('naac/c1_1_edit/' . $entry['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="bozero">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="po_pso_co_relevance" name="po_pso_co_relevance"><?php echo set_value('po_pso_co_relevance', $entry['po_pso_co_relevance']); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="curriculum_development_process">Curriculum Development Process</label>
                                                <textarea class="form-control" id="curriculum_development_process" name="curriculum_development_process"><?php echo set_value('curriculum_development_process', $entry['curriculum_development_process']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="document_link_syllabus" name="document_link_syllabus" value="<?php echo set_value('document_link_syllabus', $entry['document_link_syllabus']); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="document_link_minutes">Document Link (Minutes)</label>
                                                <input type="url" class="form-control" id="document_link_minutes" name="document_link_minutes" value="<?php echo set_value('document_link_minutes', $entry['document_link_minutes']); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
