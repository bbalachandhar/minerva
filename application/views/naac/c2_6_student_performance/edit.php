        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="<?php echo site_url('naac/c2_6_edit/' . $entry['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="bozero">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="student_id" name="student_id" value="<?php echo set_value('student_id', $entry['student_id']); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="grade_percentage">Grade Percentage</label>
                                                <input type="number" step="0.01" class="form-control" id="grade_percentage" name="grade_percentage" value="<?php echo set_value('grade_percentage', $entry['grade_percentage']); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="po_co_attainment_description">PO/CO Attainment Description</label>
                                                <textarea class="form-control" id="po_co_attainment_description" name="po_co_attainment_description"><?php echo set_value('po_co_attainment_description', $entry['po_co_attainment_description']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="document_link_results" name="document_link_results" value="<?php echo set_value('document_link_results', $entry['document_link_results']); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
