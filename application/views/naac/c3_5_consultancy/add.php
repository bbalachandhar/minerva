...
<?php echo form_open('naac/c3_5_add'); ?>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="consultant_name" name="consultant_name" value="<?php echo set_value('consultant_name'); ?>">
    </div>

    <div class="form-group">
        <label for="client_organization">Client Organization</label>
        <input type="text" class="form-control" id="client_organization" name="client_organization" value="<?php echo set_value('client_organization'); ?>">
    </div>

    <div class="form-group">
        <label for="consultancy_area">Consultancy Area</label>
        <textarea class="form-control" id="consultancy_area" name="consultancy_area"><?php echo set_value('consultancy_area'); ?></textarea>
    </div>

    <div class="form-group">
        <label for="revenue_generated_lakhs">Revenue Generated (in Lakhs)</label>
        <input type="number" step="0.01" class="form-control" id="revenue_generated_lakhs" name="revenue_generated_lakhs" value="<?php echo set_value('revenue_generated_lakhs'); ?>">
    </div>
