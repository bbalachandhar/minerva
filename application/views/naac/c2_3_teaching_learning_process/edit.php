        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="<?php echo site_url('naac/c2_3_edit/' . $entry['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="bozero">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="teaching_methodologies_used" name="teaching_methodologies_used"><?php echo set_value('teaching_methodologies_used', $entry['teaching_methodologies_used']); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="ict_tools_used">ICT Tools Used</label>
                                                <textarea class="form-control" id="ict_tools_used" name="ict_tools_used"><?php echo set_value('ict_tools_used', $entry['ict_tools_used']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="percentage_teachers_using_ict" name="percentage_teachers_using_ict" value="<?php echo set_value('percentage_teachers_using_ict', $entry['percentage_teachers_using_ict']); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="document_link_teaching_plan">Document Link (Teaching Plan)</label>
                                                <input type="url" class="form-control" id="document_link_teaching_plan" name="document_link_teaching_plan" value="<?php echo set_value('document_link_teaching_plan', $entry['document_link_teaching_plan']); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
