        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="<?php echo site_url('naac/c3_2_add'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="bozero">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="project_title" name="project_title" value="<?php echo set_value('project_title'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="funding_agency" name="funding_agency" value="<?php echo set_value('funding_agency'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="amount_received_lakhs">Amount Received (in Lakhs)</label>
                                                <input type="number" step="0.01" class="form-control" id="amount_received_lakhs" name="amount_received_lakhs" value="<?php echo set_value('amount_received_lakhs'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="project_type">Project Type</label>
                                                <input type="text" class="form-control" id="project_type" name="project_type" value="<?php echo set_value('project_type'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="document_link_sanction_letter" name="document_link_sanction_letter" value="<?php echo set_value('document_link_sanction_letter'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
