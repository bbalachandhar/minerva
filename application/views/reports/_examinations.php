...
<div class="report-nav">
    <div class="report-nav-header">
        ...
        <h3><?php echo $this->lang->line('examinations_report'); ?></h3>
    </div>
    <div class="report-tiles">
        <?php if ($this->rbac->hasPrivilege('rank_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>admin/examresult/rankreport" class="report-tile <?php echo set_SubSubmenu('Reports/examinations/rankreport'); ?>">
            <span class="tile-icon"><i class="fa fa-trophy"></i></span> <?php echo $this->lang->line('rank_report'); ?>
        </a>
        <?php } ?>
    </div>
</div>
