...
<div class="report-nav">
    <div class="report-nav-header">
        ...
        <h3><?php echo $this->lang->line('lesson_plan_report'); ?></h3>
    </div>
    <div class="report-tiles">
        <?php if ($this->rbac->hasPrivilege('syllabus_status_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>report/lesson_plan" class="report-tile <?php echo set_SubSubmenu('Reports/lesson_plan/lesson_plan'); ?>">
            <span class="tile-icon"><i class="fa fa-tasks"></i></span> <?php echo $this->lang->line('syllabus_status_report'); ?>
        </a>
