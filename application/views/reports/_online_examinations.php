...
<div class="report-nav">
    <div class="report-nav-header">
        ...
        <h3><?php echo $this->lang->line('online_examinations_report'); ?></h3>
    </div>
    <div class="report-tiles">
        <?php if ($this->rbac->hasPrivilege('online_exam_wise_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>admin/onlineexam/report" class="report-tile <?php echo set_SubSubmenu('Reports/online_examinations/online_exam_report'); ?>">
            <span class="tile-icon"><i class="fa fa-trophy"></i></span> <?php echo $this->lang->line('result_report'); ?>
        </a>
        <?php } if ($this->rbac->hasPrivilege('online_exams_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>report/onlineexams" class="report-tile <?php echo set_SubSubmenu('Reports/online_examinations/onlineexams'); ?>">
            <span class="tile-icon"><i class="fa fa-file-text"></i></span> <?php echo $this->lang->line('exams_report'); ?>
        </a>
        <?php } if ($this->rbac->hasPrivilege('online_exams_attempt_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>report/onlineexamattend" class="report-tile <?php echo set_SubSubmenu('Reports/online_examinations/onlineexamattend'); ?>">
            <span class="tile-icon"><i class="fa fa-pencil-square"></i></span> <?php echo $this->lang->line('student_exams_attempt_report'); ?>
        </a>
        <?php } if ($this->rbac->hasPrivilege('online_exams_rank_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>report/onlineexamrank" class="report-tile <?php echo set_SubSubmenu('Reports/online_examinations/onlineexamrank'); ?>">
            <span class="tile-icon"><i class="fa fa-sort-amount-desc"></i></span> <?php echo $this->lang->line('exams_rank_report'); ?>
        </a>
        <?php } ?>
    </div>
</div>
