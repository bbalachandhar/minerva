...
foreach ($communitylist as $community) {
        ?>
                                                    <option value="<?php echo $community['community'] ?>" <?php if (set_value('community') == $community['community']) {
            echo "selected=selected";
        }
        ?>><?php echo $community['community'] ?></option>
                                                    <?php
$count++;
    }
    ?>
...
?>
                        ...
                        <div class="">
                            ...
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo form_error('student'); ?> Community Based Report</h3>
                            </div>
                            <div class="box-body table-responsive">
                                    <div class="download_label">Community Based Report</div>
                            <div >
                                <table class="table table-striped table-bordered table-hover student-list" data-export-title="Community Based Report">
                                    <thead>
                                        <tr>
