        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/student_teacher_ratio') ?>" method="post" class="" id="class_search_form"  >
...
?>
                    ...
                    <div class="">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('student_teacher_ratio_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label"> <?php echo $this->lang->line('student_teacher_ratio_report'); ?></div>
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('class_section'); ?></th>
                                        <th><?php echo $this->lang->line('total_students'); ?></th>
                                        <th><?php echo $this->lang->line('total_assigned_teachers'); ?></th>
                                        <th><?php echo $this->lang->line('student_teacher_ratio'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
