...
function openAddModal() {
    ...
    $('#form1').attr('action', '<?php echo base_url(); ?>admin/income');
    $('.crud-modal-header h3').html('<i class="fa fa-plus-circle" style="color:#5b73e8;margin-right:6px;"></i> <?php echo $this->lang->line('add_income'); ?>');
    <?php if (set_value('inc_head_id')) { ?>$('#inc_head_id').val('<?php echo set_value('inc_head_id'); ?>');<?php } ?>
...
function openEditModal(el) {
    document.getElementById('form1').reset();
    var $el = $(el);
    $('#form1').attr('action', '<?php echo base_url(); ?>admin/income/edit/' + $el.data('id'));
    $('.crud-modal-header h3').html('<i class="fa fa-pencil" style="color:#5b73e8;margin-right:6px;"></i> <?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('income'); ?>');
    $('#inc_head_id').val($el.data('head'));
