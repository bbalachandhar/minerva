...
.income-list tbody tr:hover { background:#f8f9ff !important; }
        ...
        <div class="fc-page">
            ...
            <div class="fc-panel">
                ...
                <div class="fc-panel-body">
                    <form role="form" id="form1" action="<?php echo site_url('admin/income/checkvalidation') ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <input autofocus="" type="text" value="<?php echo set_value('search_text', ''); ?>" name="search_text" id="search_text" class="fc-input" placeholder="<?php echo $this->lang->line('search_by_income'); ?>">
            ...
            <div class="fc-results">
                <div class="fc-results-header">
                    <h4><i class="fa fa-money" style="margin-right:6px;color:#5b73e8;"></i> <?php echo $this->lang->line('income_list'); ?></h4>
                </div>
                <div style="padding:0 12px 12px;">
                    <div class="download_label"><?php echo $this->lang->line('income_result'); ?></div>
                    <table class="table table-hover income-list" data-export-title="<?php echo $this->lang->line('income_list'); ?>">
                        <thead>
                            <tr>
