...
<!-- Edit Item Supplier Modal -->
<?php if ($this->rbac->hasPrivilege('supplier', 'can_edit')) { ?>
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="window.location.href='<?php echo site_url('admin/itemsupplier'); ?>'" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="editModalLabel"><?php echo $this->lang->line('edit_item_supplier'); ?></h4>
            </div>
            <form action="<?php echo site_url("admin/itemsupplier/edit/" . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control" value="<?php echo set_value('name', $itemsupplier['item_supplier']); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="address" name="address" placeholder="" rows="3"><?php echo set_value('address', $itemsupplier['address']); ?></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="" rows="3"><?php echo set_value('description', $itemsupplier['description']); ?></textarea>
                ...
                <div class="modal-footer">
                    <a href="<?php echo site_url('admin/itemsupplier'); ?>" class="btn btn-default"><?php echo $this->lang->line('cancel'); ?></a>
...
<script>
    $(document).ready(function () {
        ...
        $('#editModal').on('hidden.bs.modal', function () {
            window.location.href = '<?php echo site_url("admin/itemsupplier"); ?>';
        });
