...
<div class="content-wrapper">
    ...
    <!-- Quick link to the dedicated alerts page -->
    <section class="content" style="padding-top:0;">
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo site_url('admin/vehicle/expiry_alerts'); ?>" class="btn btn-warning btn-sm" style="margin-bottom:10px;">
                    <i class="fa fa-bell"></i> Vehicle Expiry Alerts &amp; Notification Settings
                </a>
            </div>
        </div>
    </section>
