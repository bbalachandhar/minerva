                    ...
                    <form id="form1" action="<?php echo site_url('admin/librarypositionrack') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus=""  id="rack_name" name="rack_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('rack_name'); ?>" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('library_position_rack', 'can_edit')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/librarypositionrack/edit/<?php echo $positionrack['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Edit">
