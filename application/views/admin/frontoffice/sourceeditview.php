        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-bottom:16px;">
                <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px;">
                    ...
                    <a href="<?php echo site_url('admin/source'); ?>" class="btn btn-default btn-sm" style="border-radius:6px; font-weight:600;">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-pencil" style="color:#4f46e5; margin-right:6px;"></i><?php echo $this->lang->line('edit_source'); ?></h3>
                    </div>
                    <form id="form1" action="<?php echo site_url('admin/source/edit/' . $source_data['id']) ?>" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="source" value="<?php echo set_value('source', $source_data['source']); ?>" autofocus />
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" rows="3"><?php echo set_value('description', $source_data['description']); ?></textarea>
                            </div>
                        </div>
                        <div class="box-footer" style="display:flex; justify-content:space-between;">
                            <a href="<?php echo site_url('admin/source'); ?>" class="btn btn-default"><?php echo $this->lang->line('cancel'); ?></a>
