                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_add')) { ?>
                                <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addCallModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                            <?php } ?>
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_phone_call_log'); ?></h4>
            </div>
            <form id="form1" action="<?php echo site_url('admin/generalcall') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="follow_up_date" name="follow_up_date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('follow_up_date'); ?>" readonly="readonly" />
...
<script>
    ...
    $(document).ready(function () {
      ...
      <?php if (form_error('contact') || form_error('date') || form_error('call_type') || form_error('name') || form_error('follow_up_date') || form_error('call_duration') || form_error('note')) { ?>
