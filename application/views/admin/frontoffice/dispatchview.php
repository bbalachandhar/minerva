                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('postal_dispatch', 'can_add')) { ?>
                                <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addDispatchModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                            <?php } ?>
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_postal_dispatch'); ?></h4>
            </div>
            <form id="form1" action="<?php echo site_url('admin/dispatch') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo set_value('from'); ?>"  name="from">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info" id="submitbtn"><?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(function(){
        ...
        <?php if (form_error('to_title') || form_error('from') || form_error('date') || form_error('file')) { ?>
