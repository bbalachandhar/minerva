...
<div id="editCallModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="window.location.href='<?php echo site_url('admin/generalcall'); ?>'">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('edit_phone_call_log'); ?></h4>
            </div>
            <form id="form1" action="<?php echo site_url('admin/generalcall/edit/' . $Call_data['id']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $Call_data['id']; ?>">
                ...
                <div class="modal-footer">
                    <a href="<?php echo site_url('admin/generalcall'); ?>" class="btn btn-default"><?php echo $this->lang->line('cancel'); ?></a>
...
<script>
    $(document).ready(function () {
        $('#editCallModal').modal({backdrop: 'static', keyboard: false, show: true});
    });
</script>
