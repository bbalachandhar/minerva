        ...
        ?></td>
                                                            ...
                                                            <td class="mailbox-date text-right white-space-nowrap">
                                                                                                                                <?php if ($this->rbac->hasPrivilege('follow_up_admission_enquiry', 'can_view')) {?>
                                                                                                                                    ...
                                                                                                                                    <a href="<?php echo site_url('publicadmissionform?email=' . $value['email'] . '&name=' . $value['name'] . '&mobileno=' . $value['contact'] . '&enquiry_id=' . $value['id']); ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Create Admission">
