                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a href="<?php echo site_url('admin/payroll/bulk_onetime_deduction'); ?>" class="btn btn-primary btn-sm" title="Upload One-Time Deductions"><i class="fa fa-upload"></i> One-Time Deduction Upload</a>
                            <a href="<?php echo site_url('admin/payroll/pending_onetime_deductions'); ?>" class="btn btn-danger btn-sm" title="View Pending One-Time Deduction Approvals"><i class="fa fa-minus-circle"></i> Pending Deductions</a>
