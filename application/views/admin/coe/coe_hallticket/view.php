...
<div class="content-wrapper">
  <section class="content-header">
    <h1><?php echo lang('coe_hallticket'); ?> <small><?php echo htmlspecialchars($batch_exam->exam); ?></small><button type="button" class="coe-info-btn" data-toggle="modal" data-target="#coeHelpModal"><i class="fa fa-info-circle"></i></button></h1>
    <ol class="breadcrumb">
