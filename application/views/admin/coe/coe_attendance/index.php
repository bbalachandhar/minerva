        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-body">
                        <form method="get" action="<?php echo site_url('coe/coe_attendance'); ?>">
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('coe/coe_attendance/rooms/' . $ev->batch_exam_id); ?>" class="btn btn-xs btn-primary">
                                                <i class="fa fa-list"></i> View Rooms
                                            </a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
