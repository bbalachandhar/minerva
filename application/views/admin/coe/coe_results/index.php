...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-bullhorn"></i> Result Publication<button type="button" class="coe-info-btn" data-toggle="modal" data-target="#coeHelpModal"><i class="fa fa-info-circle"></i></button></h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border"><h3 class="box-title">Select Exam Event</h3></div>
                    <div class="box-body">
                        <?php if (empty($events)): ?>
                            <p class="text-muted text-center">No exam events found.</p>
                        <?php else: ?>
                        <table class="table table-bordered table-striped table-condensed">
                            <thead><tr><th>#</th><th>Exam Group</th><th>Exam</th><th>Class</th><th>Action</th></tr></thead>
                            <tbody>
