...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-sliders"></i> Moderation / Grace<button type="button" class="coe-info-btn" data-toggle="modal" data-target="#coeHelpModal"><i class="fa fa-info-circle"></i></button></h1>
        <ol class="breadcrumb">
                        ...
                        <table class="table table-bordered table-striped table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('coe/coe_moderation/listing/' . $ev->batch_exam_id); ?>"
                                           class="btn btn-xs btn-primary">
                                            <i class="fa fa-arrow-right"></i> Manage Rules
                                        </a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
