...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-pencil-square-o"></i> On-Screen Marking (OSM)<button type="button" class="coe-info-btn" data-toggle="modal" data-target="#coeHelpModal"><i class="fa fa-info-circle"></i></button></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">OSM Marking</li>
        </ol>
    </section>
                        ...
                        <table class="table table-bordered table-striped table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('coe/coe_osm/dashboard/' . $ev->batch_exam_id); ?>"
                                           class="btn btn-xs btn-primary">
                                            <i class="fa fa-arrow-right"></i> OSM Dashboard
                                        </a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
