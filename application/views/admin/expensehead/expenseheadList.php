    ...
    <section class="content">
        <div class="crud-page">
            ...
            <div class="crud-panel">
                ...
                <div class="empty-state"><i class="fa fa-credit-card"></i><p><?php echo $this->lang->line('no_record_found'); ?></p></div>
                <?php else: ?>
                <table class="crud-table example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="item-name"><?php echo $category['expense_category']; ?></td>
                            ...
                            <td style="text-align:center;white-space:nowrap;">
                                ...
                                <a href="javascript:void(0)" class="btn-action btn-action-edit"
                                   ...
                                   data-name="<?php echo htmlspecialchars($category['expense_category'], ENT_QUOTES); ?>"
                                ...
                                <a href="<?php echo base_url(); ?>admin/expensehead/delete/<?php echo $category['id']; ?>" class="btn-action btn-action-delete" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>');"><i class="fa fa-trash"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
        ...
        <form id="crudForm" action="<?php echo site_url('admin/expensehead/create'); ?>" method="post">
            ...
            <div class="crud-modal-body">
                <div class="form-grp">
                    ...
                    <input type="text" name="expensehead" id="modalName" class="crud-input" value="">
...
function openEditModal(el) {
    ...
    $('#crudForm').attr('action', '<?php echo base_url(); ?>admin/expensehead/edit/' + id);
