        ...
        <div class="crud-page">
            ...
            <div class="crud-header">
                ...
                <button class="btn-add-new" onclick="openModal()">
                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_school_house'); ?>
                </button>
                <?php endif; ?>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <a href="<?php echo base_url(); ?>admin/schoolhouse/edit/<?php echo $house['id']; ?>" class="btn-action btn-action-edit" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <?php endif; ?>
                                <?php if ($this->rbac->hasPrivilege('student_houses', 'can_delete')): ?>
                                <a href="<?php echo base_url(); ?>admin/schoolhouse/delete/<?php echo $house['id']; ?>" class="btn-action btn-action-delete" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>');">
...
<?php if (($this->rbac->hasPrivilege('student_houses', 'can_add')) || ($this->rbac->hasPrivilege('student_houses', 'can_edit'))): ?>
<?php
$form_url = !empty($house_name) ? base_url() . "admin/schoolhouse/edit/" . $id : base_url() . "admin/schoolhouse/create";
$modal_title = !empty($house_name) ? $this->lang->line('edit') : $this->lang->line('add_school_house');
?>
<div class="crud-modal-overlay" id="crudModal">
    <div class="crud-modal">
        <div class="crud-modal-header">
            <h3><i class="fa fa-plus-circle" style="color:#5b73e8;margin-right:6px;"></i> <?php echo $modal_title; ?></h3>
        ...
        <form action="<?php echo $form_url; ?>" method="post">
            ...
            <div class="crud-modal-body">
                <div class="form-grp">
                    ...
                    <input type="text" name="house_name" class="crud-input" value="<?php echo $house_name; ?>" autofocus>
                    <span class="text-danger" style="font-size:12px;"><?php echo form_error('house_name'); ?></span>
                </div>
                <div class="form-grp">
                    <label><?php echo $this->lang->line('description'); ?></label>
                    <textarea name="description" class="crud-textarea"><?php echo $description; ?></textarea>
...
<?php if (!empty($house_name) || form_error('house_name')): ?>openModal();<?php endif; ?>
</script>
