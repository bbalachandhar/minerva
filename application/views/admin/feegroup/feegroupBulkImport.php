            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('bulk_import_fees_group'); ?></h3>
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>admin/feegroup/exportformat" class="btn btn-default btn-sm"><i class="fa fa-download"></i> <?php echo $this->lang->line('download_sample_import_file'); ?></a>
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <p>2. The 'name' field is required.</p>
                        <hr/>
                    </div>
                    ...
                    <hr/>
                    <form action="<?php echo base_url(); ?>admin/feegroup/bulk_import" method="post" enctype="multipart/form-data">
                        <div class="box-body">
