            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Import Subject</h3>
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>admin/librarysubject/import_sample" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Download Sample</a>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                    ...
                    <!-- form start -->
                    <form id="form1" action="<?php echo site_url('admin/librarysubject/import') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
