...
<div class="modal fade" id="feeCollectionModal" tabindex="-1" role="dialog" aria-labelledby="feeCollectionModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/collect_incidental_fee/index') ?>" method="post" accept-charset="utf-8">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#class_id').on('change', function () {
            ...
            if (class_id) {
                $.ajax({
                    url: baseurl + 'admin/collect_incidental_fee/getSectionsByClass', // Updated AJAX endpoint
                    type: "POST",
        ...
        $(document).on('click', '.collect_fee_btn', function () {
            ...
            $('#modal_incidental_fee_assignment_id').val(''); // Clear previous assignment ID
            $('#amount_collected').val(''); // Clear previous amount
            $('#notes').val(''); // Clear previous notes
            $('#fee_type_id_modal').val(''); // Clear previous fee type selection

            // AJAX to get student details and outstanding assignments
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (outstanding_assignments.length > 0) {
                        ...
                        $.each(outstanding_assignments, function (key, assignment) {
                            ...
                            assignments_html += '<td>' + (assignment.due_date ? assignment.due_date : 'N/A') + '</td>';
        ...
        // Handle selection of an outstanding assignment
