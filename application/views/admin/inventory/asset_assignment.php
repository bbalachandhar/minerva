        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#assignModal">
                        <i class="fa fa-plus"></i> Assign Asset
                    </button>
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#bulkAssignModal">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="assignModalLabel"><i class="fa fa-user"></i> Assign Asset</h4>
            </div>
...
<!-- Bulk Assignment Upload Modal -->
<div class="modal fade" id="bulkAssignModal" tabindex="-1" role="dialog" aria-labelledby="bulkAssignModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="bulkAssignModalLabel"><i class="fa fa-upload"></i> Bulk Assignment Upload</h4>
            </div>
...
$(document).ready(function () {
    ...
    // Re-init datepicker when modal is shown (Bootstrap modals can interfere with datepicker z-index)
