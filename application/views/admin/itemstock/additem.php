...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-object-group"></i> <?php echo $this->lang->line('item'); ?></h1>
    </section>
    <!-- Main content -->
...
if ($items['description'] == "") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                    <a href="<?php echo base_url(); ?>admin/item/add/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>"><i class="fa fa-plus"></i></a>

                                                    <a href="<?php echo base_url(); ?>admin/item/edit/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
