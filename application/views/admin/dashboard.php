                    ...
                    <div class="mn-card">
                        ...
                        <div class="mn-card-body" style="padding:20px 24px;">
                            ...
                            <div style="display:flex;gap:10px;margin-top:20px;padding-top:18px;border-top:1px solid var(--mn-border);">
                                ...
                                <a href="<?php echo site_url('studentfee'); ?>" id="monthly-fees-collection-widget" data-url="<?php echo site_url('admin/admin/monthly_fees_collection_widget'); ?>" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-decoration:none;color:inherit;padding:12px 4px;border:1px solid var(--mn-border);border-radius:10px;transition:box-shadow 0.15s;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.08)'" onmouseout="this.style.boxShadow='none'">
                                ...
                                <a href="<?php echo site_url('admin/income'); ?>" id="monthly-income-widget" data-url="<?php echo site_url('admin/admin/monthly_income_widget'); ?>" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-decoration:none;color:inherit;padding:12px 4px;border:1px solid var(--mn-border);border-radius:10px;transition:box-shadow 0.15s;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.08)'" onmouseout="this.style.boxShadow='none'">
                                ...
                                <a href="<?php echo site_url('admin/expense'); ?>" id="monthly-expense-widget" data-url="<?php echo site_url('admin/admin/monthly_expense_widget'); ?>" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-decoration:none;color:inherit;padding:12px 4px;border:1px solid var(--mn-border);border-radius:10px;transition:box-shadow 0.15s;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.08)'" onmouseout="this.style.boxShadow='none'">
                                ...
                                <a href="<?php echo site_url('whatsappconfig'); ?>" id="whatsapp-msg-widget" data-url="<?php echo site_url('admin/admin/whatsapp_sent_widget'); ?>" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-decoration:none;color:inherit;padding:12px 4px;border:1px solid var(--mn-border);border-radius:10px;transition:box-shadow 0.15s;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.08)'" onmouseout="this.style.boxShadow='none'">
...
$(document).ready(function() {
    ...
    new ApexCharts(document.getElementById('doughnut-chart'), {
        chart: { type: 'donut', height: 300, fontFamily: apexDefaults.chart.fontFamily },
        ...
        plotOptions: { pie: { donut: { size: '70%' }, startAngle: -90, endAngle: 90, offsetY: 10 } },
