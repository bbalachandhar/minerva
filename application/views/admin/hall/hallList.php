        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/hall/add') ?>" id="hallform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if (!empty($hall->image)) { ?>
                                                        <img src="<?php echo base_url($hall->image); ?>" class="img-thumbnail" style="width: 50px !important; height: 50px !important;">
                                                    <?php } else { ?>
