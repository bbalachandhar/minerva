        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/hall/edit/' . $id) ?>" id="hallform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="is_active" value="1" <?php echo set_checkbox('is_active', '1', $hall->is_active); ?>> <?php echo $this->lang->line('yes'); ?>
                                </label>
                            </div>
