...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-money"></i> Balance Report Between Dates</h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('customfinancereports/balancereportbetweendates') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
    ...
    ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="start_date" name="start_date" class="form-control datepicker"
                                               value="<?php echo set_value('start_date'); ?>" placeholder="YYYY-MM-DD" autocomplete="off">
                                        <span class="text-danger"><?php echo form_error('start_date'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>To Date (Balance as on this date)</label>
                                        <input type="text" id="end_date" name="end_date" class="form-control datepicker"
                                               value="<?php echo set_value('end_date'); ?>" placeholder="YYYY-MM-DD" autocomplete="off">
                    ...
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">
                            <i class="fa fa-users"></i> Balance Report Between Dates
                            <?php if (!empty($start_date) && !empty($end_date)) { ?>
                            &nbsp;<small class="text-muted">
                                From: <?php echo date($this->customlib->getSchoolDateFormat(), strtotime($start_date)); ?>
                                &nbsp;&mdash;&nbsp;
                                As on: <?php echo date($this->customlib->getSchoolDateFormat(), strtotime($end_date)); ?>
                            </small>
                            <?php } ?>
                        </h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        getSectionByClass(class_id, section_id, department_id);
        ...
        $(document).on('change', '#department_id', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#class_id').append('<option value=""><?php echo $this->lang->line('select_all'); ?></option>');
