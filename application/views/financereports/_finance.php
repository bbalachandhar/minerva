...
<li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/categorywisebalancefeesreport'); ?>"><a href="<?php echo base_url(); ?>financereports/categorywisebalancefeesreport"><i class="fa fa-file-text-o"></i> Category wise balance fees report</a></li>
                    ...
                    <?php  } if ($this->rbac->hasPrivilege('payroll_report', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/payrollreportsummary'); ?>"><a href="<?php echo base_url(); ?>financereports/payrollreportsummary"><i class="fa fa-file-text-o"></i> Payroll Report Summary</a></li>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/payrollbankcopy'); ?>"><a href="<?php echo base_url(); ?>financereports/payrollbankcopy"><i class="fa fa-file-text-o"></i> Payroll Bank Copy</a></li>
