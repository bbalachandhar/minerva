...
<head>
    ...
    <title><?php echo $this->lang->line('user_login'); ?> : <?php echo htmlspecialchars($name); ?></title>
    ...
    <style>
        ...
        .login-footer a { color: #1F4E79; display: inline-block; margin: 4px 8px; }
...
<body>
<div class="login-bg"<?php if (!empty($school['user_login_page_background'])): ?> style="background-image:url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo htmlspecialchars($school['user_login_page_background']); ?>')"<?php endif; ?>></div>
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="login-title"><?php echo $this->lang->line('user_login'); ?></div>
        ...
        <form action="<?php echo site_url('site/userlogin'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <input type="text" name="username" value="<?php echo set_value('username'); ?>" placeholder="<?php echo $this->lang->line('username'); ?>" class="form-control" id="email" autocomplete="username" autofocus>
        ...
        <div class="login-footer">
            <a href="<?php echo site_url('site/ufpassword'); ?>"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?></a>
            <span style="color:#ccc;">|</span>
            <a href="<?php echo site_url('site/applicantlogin'); ?>"><i class="fa fa-graduation-cap"></i> Applicant Login</a>
        </div>
        ...
        <div style="text-align:center;">
            ...
            <div id="qr-section" style="display:block;margin-top:12px;">
                ...
                <div style="font-size:11px;color:#888;margin-top:6px;">Open Minerva app &rarr; tap <strong>Scan QR</strong> on the url setup screen to fill in the API URL automatically.</div>
            </div>
        </div>
    </div>
</div>
