                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="">
                            <div class="bozero">
                                ...
                                <?php 
                                $errors = [];
                                if (form_error('validate_student')) {
                                    $errors[] = form_error('validate_student');
                                }
                                        ...
                                        <?php if ($sch_setting->roll_no) {?>
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="register_no" name="register_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('register_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="regulation_id" name="regulation_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('regulation_id'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="emis_num" name="emis_num" placeholder="" type="text" class="form-control"  value="<?php echo set_value('emis_num'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="hsc_reg_no" name="hsc_reg_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('hsc_reg_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="ug_reg_no" name="ug_reg_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('ug_reg_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="abc_id" name="abc_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('abc_id'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="father_adhar_no" name="father_adhar_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_adhar_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="mother_adhar_no" name="mother_adhar_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_adhar_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="migration_cert_num" name="migration_cert_num" placeholder="" type="text" class="form-control"  value="<?php echo set_value('migration_cert_num'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="allotment_no" name="allotment_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('allotment_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="consortium_no" name="consortium_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('consortium_no'); ?>" />
                                                                                       ...
                                                                                       <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input id="application_no" name="application_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('application_no'); ?>" />
                                                ...
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('class'); ?></label><small class="req"> *</small>
                                                                                                 <select  id="class_id" name="class_id" class="form-control"  >
                                                                                                    ...
                                                                                                    <?php
                                                                                                     ...
                                                                                                     ?>
                                                                                                </select>                                                <span class="text-danger"><?php echo form_error('class_id'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
...
<!-- fees discount group -->
    <div class="mainstudent discount_div">
       <div id="fade"></div>
        ...
        <h4 class="pagetitleh2"><?php echo $this->lang->line('fees_discount_details'); ?>
