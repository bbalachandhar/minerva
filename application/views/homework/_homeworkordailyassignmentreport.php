...
<div class="report-nav">
    <div class="report-nav-header">
        <span class="nav-icon"><i class="fa fa-pencil-square"></i></span>
        <h3><?php echo $this->lang->line('homework_report'); ?></h3>
    </div>
    <div class="report-tiles">
        <?php if ($this->rbac->hasPrivilege('homework', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>homework/homeworkreport" class="report-tile <?php echo set_SubSubmenu('homework/homeworkreport'); ?>"><span class="tile-icon"><i class="fa fa-book"></i></span> <?php echo $this->lang->line('homework_report'); ?></a>
        <?php } if ($this->rbac->hasPrivilege('homehork_evaluation_report', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>homework/evaluation_report" class="report-tile <?php echo set_SubSubmenu('homework/evaluation_report'); ?>"><span class="tile-icon"><i class="fa fa-check-circle"></i></span> <?php echo $this->lang->line('homework_evaluation_report'); ?></a>
        <?php } if ($this->rbac->hasPrivilege('daily_assignment', 'can_view')) { ?>
        <a href="<?php echo base_url(); ?>homework/dailyassignmentreport" class="report-tile <?php echo set_SubSubmenu('homework/dailyassignmentreport'); ?>"><span class="tile-icon"><i class="fa fa-tasks"></i></span> <?php echo $this->lang->line('daily_assignment_report'); ?></a>
        <?php } ?>
    </div>
</div>
