...
<html dir="<?php echo ($front_setting->is_active_rtl) ? "rtl" : "ltr"; ?>" lang="<?php echo ($front_setting->is_active_rtl) ? "ar" : "en"; ?>">
    ...
    <?php if (!empty($header_image)) { ?>
        <div class="header-image-container text-center" style="padding-top: 20px; padding-bottom: 20px;">
            <img src="<?php echo base_url('uploads/print_headerfooter/online_admission_receipt/' . $header_image); ?>" alt="Header Image" style="max-width: 60%; height: auto; margin: 0 auto;">
        </div>
    <?php } ?>
                                        ...
                                        <div class="mask"><ul id="ticker01" class="newsticker">
                                                ...
                                                if (!empty($banner_notices)) {
                                                    ...
                                                    foreach ($banner_notices as $banner_notice_key => $banner_notice_value) {
                                                        ?>
                                                        <li><a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>"><div class="date"><?php echo date('d', strtotime($banner_notice_value['date'])); ?><span><?php echo date('F', strtotime($banner_notice_value['date'])); ?></span></div><?php echo date('Y', strtotime($banner_notice_value['date'])); ?>
                                                            </a></li>
                                                        <?php
                                                    }
                                                }
