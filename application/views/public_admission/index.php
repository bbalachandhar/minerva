...
?>
    <div class="row justify-content-center align-items-center flex-wrap d-flex pt20">
        ...
        <div class="col-md-6 col-lg-7 col-sm-7 text-lg-right">
            ...
            <a href="<?php echo base_url(); ?>public_admission/download/<?php echo $sch_setting->id; ?>" class='modalclosebtn modal-close-xs w-full-xs text-center'><?php echo $this->lang->line('download_application_form'); ?></a>
            <?php }?>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        function getSectionByClass(class_id, section_id) {
            if (class_id !== "") {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "public_admission/getSections",
...
<script type="text/javascript">
    function refreshCaptcha(){
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('public_admission/refreshCaptcha'); ?>",
            data: {},
