...
<html>
<head>
    <title>Edit Online Admission</title>
...
<form id="form1" class="spaceb60 spacet40 onlineform" action="<?php echo base_url() . 'public_admission/editonlineadmission/' . $reference_no ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
