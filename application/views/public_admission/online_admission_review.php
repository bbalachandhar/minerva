  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header modal-header-small">
       ...
       <form action="<?php echo base_url() . 'public_admission/checkadmissionstatus' ?>" method="post" class="onlineform" id="checkstatusform">
    ...
    <div class="row" id="printheader">
      ...
      <div class="row ">
        ...
        <div class="col-md-8 col-lg-8 col-sm-12">
            <form action="<?php echo base_url() . 'public_admission/editonlineadmission/' . $reference_no; ?>" method="post" class="">
                <div class="row">
                   ...
                   <div class="col-md-2 col-lg-2 col-sm-12">
                    <div class="statusright">
                      <?php if ($form_status == 0 && $status == "") {?>
                       ...
                       <?php }?>
                       <?php if ($form_status == 1 && $status == "") {?>
                        <a href="<?php echo site_url('public_admission/exam_list'); ?>" id="examportalbtn" class="btn printbtndrakgray btn-sm" data-toggle="tooltip" title="Open Exam Portal"><i class="fa fa-file-text-o"></i></a>
                       <?php }?>
      ...
      <div class="printcontent">
        ...
        <?php }?>
                 <?php if ($online_admission_payment == 'yes') {?>
                   ...
                   <?php } else {?>
                     <form id="admissionform" action="<?php echo base_url(); ?>public_admission/submitadmission" method="post">
                    <?php }?>
...
$(document).on('change','.currency_list',function(e){
   ...
   $.ajax({
      type: 'POST',
      url: base_url+'public_admission/changeCurrencyFormat',
