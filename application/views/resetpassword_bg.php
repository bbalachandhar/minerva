...
<head>
    ...
    <title><?php echo $this->lang->line('reset_password'); ?> : <?php echo htmlspecialchars($app_name[0]['name']); ?></title>
...
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="login-title"><?php echo $this->lang->line('reset_password'); ?></div>
        ...
        <form action="<?php echo site_url('site/resetpassword/' . $role . '/' . $verification_code); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <input type="password" name="password" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-control" id="form-password" autocomplete="new-password">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <input type="password" name="confirm_password" placeholder="<?php echo $this->lang->line('confirm_password'); ?>" class="form-control" id="form-confirm_password" autocomplete="new-password">
                    <span class="fa fa-lock"></span>
                </div>
                <span class="text-danger small"><?php echo form_error('confirm_password'); ?></span>
            </div>
            <button type="submit" class="btn-login"><?php echo $this->lang->line('submit'); ?> &nbsp;<i class="fa fa-check"></i></button>
        </form>
