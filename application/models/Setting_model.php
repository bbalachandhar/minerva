...
class Setting_model extends MY_Model {
    ...
    public function getSetting() {  
        ...
        // --- Start Specific Fix for student_self_edit ---
        // Explicitly re-fetch student_self_edit to ensure correctness
        $student_self_edit_query = $this->db->select('student_self_edit')->from('sch_settings')->get()->row();
        if ($student_self_edit_query && isset($student_self_edit_query->student_self_edit)) {
            $result->student_self_edit = $student_self_edit_query->student_self_edit;
        } else {
            // Ensure property is set even if specific query fails, to prevent undefined property errors
            $result->student_self_edit = 0; 
        }
        // --- End Specific Fix ---
