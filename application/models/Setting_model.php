...
class Setting_model extends MY_Model {
    ...
    private function getOptionalColumnSelect($table, $column, $fallback = "''") {
    ...
    public function getSetting() {  
        ...
        $auto_adjust_lop_with_preallotted_leaves = $this->getOptionalColumnSelect('sch_settings', 'auto_adjust_lop_with_preallotted_leaves', '0');

        $this->db->select('sch_settings.id,sch_settings.institution_type,sch_settings.base_url,sch_settings.folder_path,sch_settings.attendence_type,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.fee_due_days,sch_settings.staff_notification_email,sch_settings.class_teacher,sch_settings.cron_secret_key,sch_settings.timezone,sch_settings.online_admission_application_form,          sch_settings.name,sch_settings.email,sch_settings.student_biometric,sch_settings.staff_biometric,sch_settings.last_processed_attendance_date,sch_settings.biometric_device,sch_settings.phone,sch_settings.adm_prefix,sch_settings.online_admission_processing_charge_type,sch_settings.online_admission_processing_charge,sch_settings.onlineform_sub_merchant_id,sch_settings.adm_start_from,languages.language,sch_settings.adm_no_digit,sch_settings.adm_update_status,sch_settings.adm_auto_insert,sch_settings.adm_include_current_year,sch_settings.staffid_prefix,sch_settings.staffid_start_from,sch_settings.staffid_auto_insert,sch_settings.staffid_no_digit,sch_settings.staffid_update_status,sch_settings.staffid_include_current_year,sch_settings.superadmin_restriction,sch_settings.student_timeline,sch_settings.address,sch_settings.dise_code,sch_settings.date_format,sch_settings.currency,sch_settings.currency_place,sch_settings.start_month,sch_settings.start_week,sch_settings.session_id,sch_settings.image,sch_settings.theme,sessions.session,online_admission,sch_settings.online_admission_session_id,sch_settings.is_duplicate_fees_invoice,sch_settings.is_student_house,sch_settings.is_blood_group,sch_settings.roll_no,sch_settings.lastname,sch_settings.middlename,sch_settings.category,sch_settings.cast,sch_settings.religion,sch_settings.mobile_no,sch_settings.student_email,sch_settings.admission_date,sch_settings.student_photo,sch_settings.student_height,sch_settings.student_weight,sch_settings.measurement_date,sch_settings.father_name,sch_settings.father_phone,sch_settings.father_occupation,sch_settings.father_pic,sch_settings.mother_name,sch_settings.mother_phone,sch_settings.mother_occupation,sch_settings.mother_pic,sch_settings.guardian_phone,sch_settings.guardian_name,sch_settings.guardian_relation,sch_settings.guardian_email,sch_settings.guardian_pic,sch_settings.leave_approver_id,sch_settings.guardian_occupation,sch_settings.staff_self_edit,sch_settings.guardian_address,sch_settings.transport_fee_type,sch_settings.current_address,sch_settings.permanent_address,sch_settings.address,sch_settings.last_biometric_sync_datetime,sch_settings.permanent_address,sch_settings.route_list,sch_settings.hostel_id,sch_settings.bank_account_no,sch_settings.bank_name,sch_settings.ifsc_code,sch_settings.national_identification_no,sch_settings.local_identification_no,sch_settings.rte,sch_settings.previous_school_details,sch_settings.student_note,sch_settings.upload_documents,sch_settings.staff_designation,sch_settings.staff_department,sch_settings.staff_last_name,sch_settings.staff_father_name,sch_settings.staff_mother_name,sch_settings.staff_date_of_joining,sch_settings.staff_phone,sch_settings.staff_emergency_contact,sch_settings.staff_marital_status,sch_settings.staff_photo,sch_settings.staff_current_address,sch_settings.staff_permanent_address,sch_settings.staff_qualification,sch_settings.staff_work_experience,sch_settings.staff_note,sch_settings.staff_basic_salary,sch_settings.staff_contract_type,sch_settings.staff_work_shift,sch_settings.staff_work_location,sch_settings.staff_leaves,sch_settings.staff_account_details,sch_settings.staff_social_media,sch_settings.staff_upload_documents,sch_settings.admin_logo,sch_settings.admin_small_logo,sch_settings.mobile_api_url,sch_settings.app_primary_color_code,sch_settings.app_secondary_color_code,sch_settings.app_logo,languages.short_code as `language_code`,sch_settings.student_profile_edit,sch_settings.my_question,sch_settings.online_admission_payment,online_admission_amount,sch_settings.online_admission_instruction,sch_settings.online_admission_conditions,sch_settings.languages as activelanguage,sch_settings.single_page_print as single_page_print, sch_settings.student_barcode, sch_settings.staff_barcode,sch_settings.calendar_event_reminder,sch_settings.student_login,sch_settings.parent_login,sch_settings.student_panel_login,sch_settings.parent_panel_login,sch_settings.currency_format,sch_settings.exam_result,is_student_feature_lock,is_offline_fee_payment,lock_grace_period,sch_settings.collect_back_date_fees,sch_settings.event_reminder,sch_settings.event_reminder,sch_settings.maintenance_mode,currencies.symbol as currency_symbol,currencies.base_price,currencies.short_name as currency,currencies.id as currency_id,sch_settings.offline_bank_payment_instruction,sch_settings.admin_login_page_background,sch_settings.user_login_page_background,sch_settings.low_attendance_limit,sch_settings.scan_code_type,sch_settings.student_resume_download,sch_settings.download_admit_card,sch_settings.front_side_whatsapp,sch_settings.front_side_whatsapp_mobile,sch_settings.front_side_whatsapp_from,sch_settings.front_side_whatsapp_to,sch_settings.admin_panel_whatsapp ,sch_settings.admin_panel_whatsapp_mobile,sch_settings.admin_panel_whatsapp_from,sch_settings.admin_panel_whatsapp_to,sch_settings.student_panel_whatsapp,sch_settings.student_panel_whatsapp_mobile,sch_settings.student_panel_whatsapp_from,sch_settings.student_panel_whatsapp_to,sch_settings.onlineform_sub_merchant_id,sch_settings.office_end_time,sch_settings.morning_session_end_time,sch_settings.evening_session_end_time,sch_settings.max_late_allowed,sch_settings.max_permission_allowed,sch_settings.payroll_cutoff_day,sch_settings.payroll_fy_start_month,sch_settings.payroll_fy_end_month,sch_settings.auto_adjust_lop_with_leaves,' . $auto_adjust_lop_with_preallotted_leaves . ',fees_discount,sch_settings.admission_logo_left,sch_settings.admission_logo_right,sch_settings.website,sch_settings.weekend_days,sch_settings.isSecondSaturdayHoliday,sch_settings.isFourthSaturdayHoliday,sch_settings.monthly_leave_increment_enabled,sch_settings.monthly_increment_leave_type_id,sch_settings.monthly_increment_days,sch_settings.leave_reset_month,sch_settings.last_leave_increment_processed,sch_settings.meta_leads_enabled,sch_settings.meta_verify_token,sch_settings.meta_app_secret,sch_settings.meta_page_access_token,sch_settings.meta_form_id,sch_settings.meta_page_id,sch_settings.meta_default_course_id');  
        ...
        // --- Start Specific Fix for staff_profile_edit ---
        // Explicitly re-fetch staff_profile_edit to ensure correctness
        $staff_profile_edit_query = $this->db->select('staff_profile_edit')->from('sch_settings')->get()->row();
        if ($staff_profile_edit_query && isset($staff_profile_edit_query->staff_profile_edit)) {
            $result->staff_profile_edit = $staff_profile_edit_query->staff_profile_edit;
        } else {
            // Ensure property is set even if specific query fails, to prevent undefined property errors
            $result->staff_profile_edit = 0; 
        }
        // --- End Specific Fix ---
                ...
                if (is_null($result)) {
                    ...
                    $default_setting->office_end_time = '';
                    $default_setting->morning_session_end_time = '';
                    $default_setting->evening_session_end_time = '';
                    $default_setting->max_late_allowed = 0;
                    $default_setting->max_permission_allowed = 0;
    ...
    public function getOnlineAdmissionSessionId() {
        $result = $this->db->select('online_admission_session_id, session_id')
            ->where('id', 1)
            ->get('sch_settings')
            ->row_array();
        // Fall back to active academic session if not explicitly configured
        return !empty($result['online_admission_session_id'])
            ? (int) $result['online_admission_session_id']
